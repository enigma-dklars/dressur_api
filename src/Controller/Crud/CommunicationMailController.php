...
class CommunicationMailController extends AbstractController
{
    ...
    private static function getMessagePersonnaliseAudiences(bool $includeActiveBoostAudience = false): array
    {
        $audiences = [
            ...
            'boost_date_payant_sans_quota' => [
                'label' => 'Boost Contact payant par date sans aucun quota',
                'group' => 'Historique des services',
                'description' => 'A utilisé un Boost Contact payant de type date, mais jamais de Boost Contact de type quota, gratuit ou payant.',
                'emoji' => '📆',
                'titre' => 'Message Personnalisé — Boost Contact par date sans quota',
            ],
            'promo_all' => [
    ...
    private function getMessagePersonnaliseAudienceUsers(
        ...
        return match ($audienceKey) {
            ...
            'boost_date_payant_sans_quota' => $boostRepository->findUsersWithPaidDateBoostWithoutQuotaWithDetails(),
