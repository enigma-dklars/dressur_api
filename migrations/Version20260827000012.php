...
final class Version20260827000012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE promo_reseau SET reference = CONCAT('pr_', LOWER(SUBSTRING(SHA2(CONCAT(id, '-dressur-public-reference'), 256), 1, 24))) WHERE reference IS NULL");
        $this->addSql('ALTER TABLE promo_reseau MODIFY reference VARCHAR(40) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_PROMO_RESEAU_REFERENCE ON promo_reseau');
