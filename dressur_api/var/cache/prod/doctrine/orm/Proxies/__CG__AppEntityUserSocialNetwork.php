 ...
 */
class UserSocialNetwork extends \App\Entity\UserSocialNetwork implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\UserSocialNetwork' . "\0" . 'id', '' . "\0" . 'App\\Entity\\UserSocialNetwork' . "\0" . 'user', '' . "\0" . 'App\\Entity\\UserSocialNetwork' . "\0" . 'networkType', '' . "\0" . 'App\\Entity\\UserSocialNetwork' . "\0" . 'url', '' . "\0" . 'App\\Entity\\UserSocialNetwork' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\UserSocialNetwork' . "\0" . 'updatedAt'];
        }
